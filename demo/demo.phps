 ...
 *    http://host.name/path/to/phpcsscrunch/demo/demo.php
 *
 *    For example, in a dev environment:
 *    http://project.locahost/vendor/phpcsscrunch/demo/demo.php
 */
...
$crunch = new PhpCssCrunch($sourceFiles, $minifiedFile, $_SERVER['DOCUMENT_ROOT']);
$css = $crunch->process(PhpCssCrunch::MINIFY_NONE)->toString(); // just need the combined CSS
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
echo PhpCssCrunch::minify(
    ...
    PhpCssCrunch::MINIFY_HIGH
);
?></style>
</head>
<body>
<header>
    <h1>PHP CSS Crunch Demo</h1>
    <a href="https://github.com/lmd-code/phpcsscrunch">
        <div id="gh">
...
<main>
    ...
    <p><textarea id="cssout1" cols="80" rows="15"><?php
        echo PhpCssCrunch::minify($css, PhpCssCrunch::MINIFY_LOW);
    ?></textarea></p>

    <h2><label for="cssout2"><code>MINIFY_LEVEL_MEDIUM (2)</code></label></h2>
    <p><textarea id="cssout2" cols="80" rows="15"><?php
        echo PhpCssCrunch::minify($css, PhpCssCrunch::MINIFY_MEDIUM);
    ?></textarea></p>
